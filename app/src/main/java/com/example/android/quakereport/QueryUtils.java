...
public final class QueryUtils {
    ...
    private static URL createUrl(Context context, String stringUrl) {
        URL url = null;
        final String START_DATE_PARAM = "starttime";
        final String END_DATE_PARAM = "endtime";
        final String MAGNITUDE_PARAM = "minmag";
        final String LIMIT_PARAM = "limit";

        try {
            Uri builtUri = Uri.parse(stringUrl).buildUpon()
                    .appendQueryParameter(START_DATE_PARAM, getPreferredStartDate(context))
                    .appendQueryParameter(END_DATE_PARAM, getPreferredEndDate(context))
                    .appendQueryParameter(MAGNITUDE_PARAM, getPreferredMagnitude(context))
    ...
    public static String getPreferredStartDate(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_start_date_key),
                context.getString(R.string.pref_start_date_default));
    }

    public static String getPreferredEndDate(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_end_date_key),
                context.getString(R.string.pref_end_date_default));
    }

    public static String getPreferredMagnitude(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_magnitude_key),
                context.getString(R.string.pref_magnitude_default));
    }

    public static ArrayList<Earthquake> extractEarthquakes(Context context, String requestUrl) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem dealing with inputStream", e);
        }*/ catch (IOException e) {
            ...
            throws IOException
    {
        ...
        try
        {
            ...
            Log.e(LOG_TAG, "about to connect");
            ...
            if(urlConnection.getResponseCode() == 200)
            {
                ...
                Log.e("QueryUtils", "response code correct");
        ...
        {
            Log.e(LOG_TAG, "Problem retrieving from internet ", e);
        }finally {
    ...
    static public void setStartDate(Context c){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        SharedPreferences.Editor spe = sp.edit();
        spe.putInt(c.getString(R.string.pref_start_date_key), INVALID_START_DATE);
        spe.apply();
    }
